...
function Home() {
  return (
    <React.Fragment>
          <nav>
              <div className="nav__logo">HBDW</div>
                  ...
                  <div className="client__grid">
                      <div className="client__card">
                          ...
                          <p>
                              ...
                              instant. I highly recommend HBDW for hassle-free hotel bookings.
                          </p>
                      </div>
                      <div className="client__card">
                      ...
                      <div className="client__card">
                          ...
                          <p>
                              ...
                              my expectations. I appreciate HBDW's efficiency and reliability.
                          </p>
                      </div>
                  </div>
              </div>
          ...
          <footer className="footer">
              <div className="section__container footer__container">
                  <div className="footer__col">
                      <h3>HBDW</h3>
                      <p>
                          HBDW is a premier hotel booking website that offers a seamless and
                          convenient way to find and book accommodations worldwide.
                      </p>
                      <p>
                          With a user-friendly interface and a vast selection of hotels,
                          HBDW aims to provide a stress-free experience for travelers
              ...
              <div className="footer__bar">
                  Copyright © 2023 Hassan Assaad. All rights reserved.
              </div>
          </footer>
    </React.Fragment>
  )
